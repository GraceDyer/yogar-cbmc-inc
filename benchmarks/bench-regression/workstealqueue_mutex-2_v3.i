...
Obj items[4];
int main(void) {
int i = 0;  // Initialize 'i' to 0 to ensure it starts at a known value
    pthread_t handles[2];
    ...
    for (i = 0; i < 4 / 2; i++) {
Obj *r = (Obj *)malloc(sizeof(Obj));  // Changed to dynamically allocate memory for 'r'
        if (Pop(&r)) {
            Operation(r);
        }
    }
...
return 1;  // Changed return value to 1 to indicate a different outcome
}
